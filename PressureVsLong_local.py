...
from pygoda import ncgoda, findClimoFile, diffColor
import os, sys
import argparse
...
for var in varlist:
	...
	plt.subplot(3,1,1)
	tplot = plt.contourf(master.test,17, cmap = plt.cm.RdBu_r)
	...
	plt.subplot(3,1,2)
	cplot = plt.contourf(master.control,17, cmap = plt.cm.RdBu_r)
	...
	dplot = plt.contourf(master.test - master.control, diffclev, cmap = plt.cm.RdBu_r)
