...
if mkdir:
	...
	if not os.path.exists("camDiffMap"):
		os.mkdir("camDiffMap")
		print "Created directory " + "camDiffMap"

	# Create the region directory if it doesn't already exist
	if not os.path.exists("camDiffMap/" + region_name):
		os.mkdir("camDiffMap/" + region_name)
		print "Created directory " + "camDiffMap/" + region_name

	# Create season directory inside region directory
	if not os.path.exists("camDiffMap/" + region_name + "/" + season):
		os.mkdir("camDiffMap/" + region_name + "/" + season)
		print "Created directory " + "camDiffMap/" + region_name + "/" + season
...
if mkdir:
	os.chdir("camDiffMap/" + region_name + "/" + season)
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#------------- Map creation ---------------------------------------------------------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
