...
if mkdir:
	...
	if not os.path.exists("camMap"):
		os.mkdir("camMap")
		if verbose:
			print "Created directory " + "camMap"

	# Create the region directory if it doesn't already exist
	if not os.path.exists("camMap/" + region_name):
		os.mkdir("camMap/" + region_name)
		if verbose:
			print "Created directory " + "camMap/" + region_name
